...
<head>
	...
	<script>
		function search() {
			...
			location.href = '/jw/dog/board/list?p=${currentBoardPage}&f=' + field + '&q=' + query;
					...
					<tr>
						<td style="width: 52%; text-align:left">
							<h3><strong class="me-5">게시글 목록</strong>
								<span style="font-size:16px"><a href="/jw/dog/board/insert"><i class="fa-solid fa-pen-to-square"></i>글 쓰기</a></span>
							</h3>
						</td>
						<td style="width: 16%">
			...
			<table class="table">
				<tr>
					...
					<tr>
						<td>${board.boardId}</td>
						<td>
							<a href="/jw/bbs/board/detail?boardId=${board.boardId}&uid=${board.uId}">${board.title}</a>
				...
				<%-- pagination --%>
					 ...
					 <c:forEach var="page" items="${pageList}">
						  	<li class="page-item ${currentBoardPage eq page ? 'active' : '' }">
						  		<a class="page-link" href="/jw/dog/board/list?p=${page}&f=${field}&q=${query}">${page}</a>
						  	</li>	
					</c:forEach>
